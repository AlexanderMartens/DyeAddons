...
class CelesteStatistics(
    ...
    listOf(
        StatisticField("T1 Sven Packmaster Kills", Parsers.INT, true),
        StatisticField("T2 Sven Packmaster Kills", Parsers.INT, true),
        StatisticField("T3 Sven Packmaster Kills", Parsers.INT, true),
        StatisticField("T4 Sven Packmaster Kills", Parsers.INT, true)),
    Dye.CELESTE
) {
    ...
    override fun getProgress(): Double {
        ...
        val t1Kills = context.getMultipliedInt("T1 Sven Packmaster Kills")
        val t2Kills = context.getMultipliedInt("T2 Sven Packmaster Kills")
        val t3Kills = context.getMultipliedInt("T3 Sven Packmaster Kills")
        val t4Kills = context.getMultipliedInt("T4 Sven Packmaster Kills")
