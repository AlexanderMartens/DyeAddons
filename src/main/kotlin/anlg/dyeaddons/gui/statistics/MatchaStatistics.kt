...
class MatchaStatistics(
    ...
    override fun loadFromApi() {
        ...
        val slayerStats = profileStats?.slayer?.objPath("slayer_bosses", "zombie")
        ...
        (this.widgets["T1 Revenant Horror Kills"]?.widget as EditBox).value = t1Kills.toString()
        (this.widgets["T2 Revenant Horror Kills"]?.widget as EditBox).value = t2Kills.toString()
        (this.widgets["T3 Revenant Horror Kills"]?.widget as EditBox).value = t3Kills.toString()
        (this.widgets["T4 Revenant Horror Kills"]?.widget as EditBox).value = t4Kills.toString()
        (this.widgets["T5 Revenant Horror Kills"]?.widget as EditBox).value = t5Kills.toString()
    }
